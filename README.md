...
- Таблица проекта рендерит только текущую страницу IP-записей; размер страницы задается `PROJECT_TABLE_DEFAULT_PAGE_SIZE`, пользователь может переключать 25/50/100/250 строк.
