...
- Скрытие незаполненных IP-записей в таблице проекта по умолчанию.
...
7. Вернитесь к режиму скрытия пустых строк и проверьте, что отображаются только заполненные или проверенные строки.
