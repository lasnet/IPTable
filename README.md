...
- Действия папок и проектов в боковой панели спрятаны в hover-меню `⋯`, чтобы дерево оставалось компактным. Создание проекта, экспорт и настройка ping открываются в модальных окнах, а не внутри sidebar.
