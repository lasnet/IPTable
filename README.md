...
- Компактный action bar проекта: отдельно остаются только `Show hidden` и `+ Column`, а `Ping`, история, экспорт и настройки проекта находятся в меню `⋯` с учетом прав пользователя.
